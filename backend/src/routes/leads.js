...
import { ingestLeadStream, getWorkspaceLeads , updateLeadStatus , revealSensitiveContact ,publicLeadIngest} from '../controllers/leadController.js';
...
router.post('/public-ingest', publicLeadIngest);
